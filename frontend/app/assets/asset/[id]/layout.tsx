      ...
      <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6">
        <div className="flex items-center justify-center py-12">
          <div className="text-center">
            <Database className="mx-auto text-destructive mb-4" />
            <h3 className="text-lg font-semibold mb-2">加载失败</h3>
            <p className="text-muted-foreground">
              {error.message || "获取资产数据时出现错误"}
            </p>
          </div>
        </div>
      </div>
  ...
  if (!asset) {
    return (
      <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6">
        <div className="flex items-center justify-center py-12">
          <div className="text-center">
            <Database className="mx-auto text-muted-foreground mb-4" />
            <h3 className="text-lg font-semibold mb-2">资产不存在</h3>
            <p className="text-muted-foreground">
              未找到ID为 {id} 的资产
            </p>
          </div>
    ...
    <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6">
      ...
      <div className="flex items-center justify-between px-4 lg:px-6">
        <div>
          ...
          <p className="text-muted-foreground">{asset.description || "暂无描述"}</p>
        </div>
      </div>
