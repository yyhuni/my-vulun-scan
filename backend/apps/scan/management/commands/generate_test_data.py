...
用法：
    python manage.py generate_test_data --target xinye.com --count 100000
    
性能测试：
    python manage.py generate_test_data --target xinye.com --count 10000 --batch-size 500 --benchmark
"""
