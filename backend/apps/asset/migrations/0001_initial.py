    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-discovered_at'],
                'indexes': [models.Index(fields=['scan'], name='endpoint_sn_scan_id_6ac9a7_idx'), models.Index(fields=['url'], name='endpoint_sn_url_205160_idx'), models.Index(fields=['-discovered_at'], name='endpoint_sn_discove_b16f7b_idx')],
        ...
        migrations.AddConstraint(
            model_name='website',
            constraint=models.UniqueConstraint(condition=models.Q(('deleted_at__isnull', True)), fields=('url', 'target'), name='unique_url_target_active'),
        ),
        migrations.AddIndex(
            model_name='endpoint',
        ...
        migrations.AddIndex(
            model_name='endpoint',
            index=models.Index(fields=['url'], name='endpoint_url_30f66e_idx'),
        ),
        migrations.AddIndex(
            model_name='endpoint',
