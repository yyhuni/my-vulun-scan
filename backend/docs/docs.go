...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.RemoveOrgDomainRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/models.RemoveOrgDomainResponseData"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "models.RemoveOrgDomainResponseData": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string"
